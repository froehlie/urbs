...
def def_storage_power_rule(m, sit, sto, com):
    ...
    if m.storage_dict['inst-cap-p'][(sit, sto, com)] < m.storage_dict['cap-up-p'][(sit, sto, com)]:
        return (m.cap_sto_p[sit, sto, com] ==
            m.cap_sto_p_new[sit, sto, com] +
            m.storage_dict['inst-cap-p'][(sit, sto, com)])
    else:
        return (m.cap_sto_p[sit, sto, com] == m.storage_dict['inst-cap-p'][(sit, sto, com)])
...
def def_storage_capacity_rule(m, sit, sto, com):
    ...
    if m.storage_dict['inst-cap-c'][(sit, sto, com)] < m.storage_dict['cap-up-c'][(sit, sto, com)]:
       return (m.cap_sto_c[sit, sto, com] ==
            m.cap_sto_c_new[sit, sto, com] +
            m.storage_dict['inst-cap-c'][(sit, sto, com)])
    else:
        return (m.cap_sto_c[sit,sto,com] == m.storage_dict['inst-cap-c'][(sit, sto, com)])

...
def def_process_capacity_rule(m, sit, pro):
    if m.process_dict['inst-cap'][(sit,pro)] < m.process_dict['cap-up'][(sit,pro)]:
        return (m.cap_pro[sit, pro] ==
                m.cap_pro_new[sit, pro] +
                m.process_dict['inst-cap'][(sit, pro)])
    else:
        return (m.cap_pro[sit, pro] == m.process_dict['inst-cap'][(sit, pro)])
    """return (m.cap_pro[sit, pro] ==
                m.cap_pro_new[sit, pro] +
                m.process_dict['inst-cap'][(sit, pro)])"""
# process capacity == existing capacity
#def def_process_const_capacity_rule(m, sit, pro):												
	#return m.cap_pro[sit, pro] == m.process_dict['inst-cap'][(sit,pro)]
